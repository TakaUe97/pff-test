...
var skipFallback = getParameterByName('skipFallback');
			...
			for (var node of mutation.addedNodes) {
				if (node.id === 'carbonads') {
					...
					if (links.length > 0) {
						...
						if (skipFallback && adHref && adHref.startsWith('https://mailto:hello@welldonecode.com')) {
...
script.onerror = function() { window.PP_postMessage("next_ad_provider", true); };
